                ...
                <ul class="list-inline">
                    <li class="list-inline-item dropdown notification-list topbar-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-center profile-dropdown ">
                            <!-- item-->
                            <div class="dropdown-header noti-title">
                                <h6 class="text-overflow m-0">{{ translate_title('Welcome !')}}</h6>
                            </div>
                        ...
                        <!-- item-->
                            <a href="auth-lock-screen.html" class="dropdown-item notify-item">
                                <i class="fe-lock"></i>
                                <span>{{ translate_title('Lock Screen')}}</span>
                            </a>
                ...
                <ul id="side-menu">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <!-- <span class="badge bg-success rounded-pill float-end">9+</span> -->
                            {{-- <span> Order </span> --}}
                            <span> {{ translate_title('Order') }} </span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="mdi mdi-account-star-outline"></i>
                            <span> {{ translate_title('Users') }} </span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="mdi mdi-checkbox-blank-circle-outline"></i>
                            <span> {{ translate_title('Color') }} </span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="mdi mdi-map-marker-outline"></i>
                            <span> {{ translate_title('Pick up point') }} </span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="mdi mdi-account-outline"></i>
                            <span> {{ translate_title('Sizes') }} </span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span> {{ translate_title('Coupon') }} </span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="mdi mdi-shopping-outline"></i>
                            <span> {{ translate_title('Characterized products') }} </span>
                        </a>
                    </li>
                    <li>
                        <a href="#categoryMenus" data-bs-toggle="collapse">
                            <i class="mdi mdi-format-list-bulleted"></i>
                            <span> {{ translate_title('Category') }} </span>
                        ...
                        <div class="collapse" id="categoryMenus">
                            <ul class="nav-second-level">
                                ...
                                <li>
                                    <a href="#">
                                        <i class="mdi mdi-format-list-bulleted"></i>
                                        <span> {{ translate_title('Sub Category') }} </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="mdi mdi-format-list-bulleted"></i>
                                        <span> {{ translate_title('Sub Sub Category') }} </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    <i class="dripicons-warning h1 text-warning"></i>
                    <h4 class="mt-2">{{ translate_title('Are you sure delete this data')}}</h4>
