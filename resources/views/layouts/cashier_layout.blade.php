        ...
        <div class="h-100">
            ...
            <div class="user-box text-center">
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item">
                        <button  type="button" class="btn btn-warning user_edit_logout" data-bs-toggle="modal" data-bs-target="#logout-alert-modal" data-url="{{ route('logout') }}">
                ...
                <ul id="side-menu">
                    ...
                    <li>
                        <a href="{{route('cashier-product.index')}}">
                            ...
                            <span> {{translate_title('Warehouse')}} </span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('cashbox.index')}}">
                            <i class="mdi mdi-cash-register me-1"></i>
                            <span> {{translate_title('Cashbox')}} </span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('clients.index')}}">
                            <i class="fa fa-user me-1"></i>
                            <span> {{translate_title('Client')}} </span>
                        </a>
                    </li>
                </ul>
