                    ...
                    <form class="modal-body needs-validation" action="{{route('users.update', $user['id'])}}" method="POST" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 mb-3 d-flex align-items-center">
                                <label for="male" class="me-2 form-check-label">{{translate_title('Male')}}</label>
                                ...
                                <label for="female" class="me-2 form-check-label">{{translate_title('Female')}}</label>
                            ...
                            <div class="col-2 mb-3 d-flex align-items-center">
                                <label class="form-check-label me-2" for="status_">{{translate_title('Status')}}</label>
                                <input class="form-check-input rounded-circle" type="checkbox" name="status" id="status_" {{(int)$user['status'] == 0?'checked':''}}>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 col-4">
                                <label for="birth_date" class="form-label" for="status_">{{translate_title('Birth date')}}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                <label for="password" class="form-label">{{translate_title('Current password')}}</label>
