    ...
    <div class="main-content-section">
        <div class="order-section">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="modal-body needs-validation" action="{{route('companies.update', $company['id'])}}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" id="address" class="form-control" name="address" value="{{$company['address']?$company['address']->name:''}}">
                            </div>
                        </div>
