            ...
            <div class="card">
                <div class="tab-content card-body" id="discount_tab">
                    <div class="tab-pane fade show active" id="discount" role="tabpanel" aria-labelledby="discount-tab">
                        ...
                        <form action="{{route('cashier-discount.update', $discount->id)}}" class="parsley-examples needs-validation modal-body" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method("PUT")
                            <div class="row">
